...
class App(tk.Tk):
    ...
    def get_sender_name(self,acceptabe_change_responsible):
        self.sender_win = Toplevel(self.main_win)
        self.main_win.withdraw()
        self.sender_win.title(" Please Select Your Name To Proceed")
        ...
        self.sender_win.protocol(
            "WM_DELETE_WINDOW", lambda: self.sender_win_quit(1))
